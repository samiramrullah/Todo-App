...
const Contact = () => {
	return (
		<div className="my-6 mt-4 md:mt-32">
			<div className="max-w-max h-3/4 mx-auto bg-[#2e0249] rounded-lg">
				<div className="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]">
					<div>
						...
						<ul className="mt-12 space-y-8">
							<li className="flex items-center">
								...
								<a href="mailto:samiramrullah@gmail.com" className="text-white text-sm ml-3">
									<strong>samiramrullah@gmail.com</strong>
								</a>
							...
							<li className="flex items-center">
								...
								<a href="1" className="text-white text-sm ml-3">
									<strong>+91 9041952237</strong>
								</a>
							</li>
							<li className="flex items-center">
						...
						<ul className="flex mt-12 space-x-4">
							<li className="bg-[#a91079] hover:bg-[#a91079e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
								<a href="https://www.facebook.com/samiramrullah/" target='facebook'>
							...
							<li className="bg-[#a91079] hover:bg-[#a91079e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
								<a href="https://www.linkedin.com/in/samiramrullah/" target='_likedin'>
									<svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill='#fff'
										viewBox="0 0 511 512">
										<path
							...
							<li className="bg-[#a91079] hover:bg-[#a91079e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
								<a href="https://www.instagram.com/samiramrullah/" target='_instagram'>
									<svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill='#fff'
										viewBox="0 0 24 24">
										<path
					...
					<div className="bg-gray-200 p-6 rounded-lg">
						<p className="text-sm font-semibold text-[#333]">Please contact for...</p>
						<div className="space-y-4 max-lg:mt-4">
							<button type="button" className="px-4 py-2 rounded-md bg-[#a91079] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#a91079] mr-4">Web Development</button>
							<button type="button" className="px-4 py-2 rounded-md bg-[#a91079] text-white text-sm tracking-wider font-medium outline-none border-2 border-gray-300 mr-4">App Development</button>
							<button type="button" className="px-4 py-2 rounded-md bg-[#a91079] text-white text-sm tracking-wider font-medium outline-none border-2 border-gray-300">Machine Learning</button>
						</div>
